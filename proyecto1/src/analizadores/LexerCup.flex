...
"=="           {return new Symbol(sym.T_EQUAL, yyline, yychar, yytext());}
"<="           {return new Symbol(sym.MIN_EQUAL, yyline, yychar, yytext());}
">="           {return new Symbol(sym.GREATER_EQUAL, yyline, yychar, yytext());}
"!="           {return new Symbol(sym.DISTINCT, yyline, yychar, yytext());}
