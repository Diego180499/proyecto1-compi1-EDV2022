...
"main"   {return new Token(TokenConstant.MAIN, yytext(), yyline, yycolumn);}


//Signos
"++"           {return new Token(TokenConstant.INCREMENT, yytext(), yyline, yycolumn);}
"--"           {return new Token(TokenConstant.DECREMENT, yytext(), yyline, yycolumn);}
...
"=="           {return new Token(TokenConstant.T_EQUAL, yytext(), yyline, yycolumn);}
"<="           {return new Token(TokenConstant.MIN_EQUAL, yytext(), yyline, yycolumn);}
">="           {return new Token(TokenConstant.GREATER_EQUAL, yytext(), yyline, yycolumn);}
"!="           {return new Token(TokenConstant.DISTINCT, yytext(), yyline, yycolumn);}
"&&"           {return new Token(TokenConstant.AND, yytext(), yyline, yycolumn);}
"||"           {return new Token(TokenConstant.OR, yytext(), yyline, yycolumn);}
"!"           {return new Token(TokenConstant.NOT, yytext(), yyline, yycolumn);}
